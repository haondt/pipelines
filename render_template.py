...
def get_images():
    return {
        ...
        'docker_deployer': 'registry.gitlab.com/haondt/cicd/registry/docker-deployer:latest',
...
def render_template(env, task, task_type = None):
...
def main():
    ...
    rendered = render_template(env, task, template_name)
